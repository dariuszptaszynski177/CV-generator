	...
	if(isset($_SESSION['cloak_to'])){ ?>
		...
		<div>
			...
			<form action="" method="POST">
					...
					<input class="btn btn-success" type="submit" name="submit" value="Dodaj szablon">
			...
			if(isset($_POST['submit']))
			{
					...
					$dodaj_szablon=$db->query("INSERT INTO szablony_wlasne (id, konto, nazwa, dodano) VALUES (null, '$jakie_konto', '$nazwa', '$data')");
					
					if($dodaj_szablon==true)
					{
					header("Location: szablony_dodaj_ustawienia.php?nazwa=$nazwa&data=$data");
					}
