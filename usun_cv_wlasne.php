...
<div id="page-wrapper">
	...
	if(isset($_SESSION['cloak_to'])){ ?>
		...
		$usun_cv=$db->query("DELETE FROM nazwa_cv_wlasne WHERE id='$id'");
		
		if($usun_cv==true)
		{
		echo "<h3 style='color:red;'>CV zostało usunięte</h3>";
		echo "<br />Kliknij <a href='twoje_cv.php'>TUTAJ</a>, aby przejść do listy z Twoimi CV "; 
		}
