...
<div id="page-wrapper">
	...
	if(isset($_SESSION['cloak_to'])){ ?>
		...
		<div>
			...
			<a href="cv_bez_konta.php" style="text-decoration: none;">
			<div style="margin-left:auto;margin-right:auto;width:45%; height:200px; background-image: url(/image/tlo.jpg) ;border:solid black 1px;  border-radius: 25px; text-align:center;">
				<h1 style="position:relative;top:50px;">Wygeneruj CV bez konta</h1>
			</div>
			</a>
