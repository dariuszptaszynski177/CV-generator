...
<div id="page-wrapper">
	...
	if(isset($_SESSION['cloak_to'])){ ?>
		...
		$pobierz_dane=$db->query("SELECT * FROM nazwa_cv WHERE konto='$jakie_konto'  and nazwa='$nazwa_cv' and dodano='$data'");
		...
		$doswiadczenie_zamien="<br /><br /><ul><li>".str_replace(",","</li><li>",$record->doswiadczenie)."</li></ul>";
		$doswiadczenie=$doswiadczenie_zamien;
		
		$wyksztalcenie_zamien="<br /><br /><ul><li>".str_replace(",","</li><li>",$record->wyksztalcenie)."</li></ul>";
		$wyksztalcenie=$wyksztalcenie_zamien;
		
		$jezyki_zamien="<br /><br /><ul><li>".str_replace(",","</li><li>",$record->jezyki)."</li></ul>";
		$jezyki=$jezyki_zamien;
		
		$zainteresowania_zamien="<br /><br /><ul><li>".str_replace(",","</li><li>",$record->zainteresowania)."</li></ul>";
		$zainteresowania=$zainteresowania_zamien;
		
		$umiejetnosci_zamien="<br /><br /><ul><li>".str_replace(",","</li><li>",$record->umiejetnosci)."</li></ul>";
		...
		$generator="generuj".$id_szablonu.".php";
		
		?>
		
		<form action="<?php echo $generator ?>" method="post" target="_blank">
